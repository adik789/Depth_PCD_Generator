    ...
    if input_path is not None:
        ...
        for index, image_name in enumerate(image_names):
            ...
            if output_path is not None:
                ...
                filename_ixml = os.path.join(input_path, 'mast_' + str(index) + '.xml')
                filename_oxml = os.path.join(output_path, 'mast_' + str(index) + '.xml')
                if not side:
                ...
                shutil.copy(os.path.join(os.getcwd(), filename_ixml), os.path.join(os.getcwd(), filename_oxml))
